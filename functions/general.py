...
### Contains various functions that are used by the operators.
...
def affine_matrix_from_points(v0, v1, shear=True, scale=True, usesvd=True):
    ...
    if ndims < 2 or v0.shape[1] < ndims or v0.shape != v1.shape:
        ...
        raise ValueError("input arrays are of wrong shape or type, or objects are outside of minimum starting distance.")
