...
class OBJECT_OT_icp_align_feedback(Operator):
    ...
    def poll(cls, context):
        ...
        if bpy.context.scene.baseObj != "" and bpy.context.scene.alignObj != "":
            return True
        else:
            return False
    ...
    def execute(self, context):
        ...
        base_obj = base_obj = bpy.context.scene.objects.get(bpy.context.scene.baseObj)
