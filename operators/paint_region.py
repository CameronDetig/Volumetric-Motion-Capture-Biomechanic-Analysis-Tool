...
class OBJECT_OT_paint_region(Operator):
    """Adds a vertex group and puts in weight paint mode"""
    bl_idname = "object.paint_region"
    ...
    def execute(self, context):
        print ("paint " + self.regionName)

        if self.regionName not in context.object.vertex_groups:
            new_group = context.object.vertex_groups.new(name = self.regionName)
